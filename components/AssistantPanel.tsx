...
import { Sparkles, X, Send, Bot, Loader2, ChevronRight } from 'lucide-react';
...
const AssistantPanel: React.FC<AssistantPanelProps> = ({ items, isOpen, onToggle }) => {
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-full sm:w-96 bg-white shadow-2xl z-50 flex flex-col transform transition-transform duration-300 border-l border-slate-200">
      ...
      <div className="p-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50 backdrop-blur">
        ...
        <button onClick={onToggle} className="text-slate-400 hover:text-slate-600 p-2 rounded-lg hover:bg-slate-100 transition-colors">
